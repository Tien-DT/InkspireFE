    ...
    <div className='p-6 space-y-4'>
      ...
      <div className='bg-gray-100 p-4 rounded'>
        ...
        <div className='flex items-center gap-2'>
          ...
          <span>Auth Ready: {authReady ? 'Yes' : 'No'}</span>
        </div>
      ...
      <div className='bg-gray-100 p-4 rounded'>
        ...
        <p className='text-sm text-gray-600 mb-3'>Test silent refresh bằng cách click button bên dưới</p>
        <div className='space-y-2'>
          <Button onClick={handleManualRefresh} className='flex items-center gap-2'>
            <RefreshCw className='h-4 w-4' />
            Thực hiện Silent Refresh
          </Button>
          <p className='text-xs text-gray-500'>Should refresh: {shouldRefresh() ? 'Yes' : 'No'}</p>
        </div>
      </div>

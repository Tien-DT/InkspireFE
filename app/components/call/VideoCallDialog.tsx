...
export function VideoCallDialog() {
  const { callState, endCall, toggleAudio, toggleVideo, isInCall } = useVideoCall()
        ...
        <div className='relative w-full h-full flex flex-col'>
          ...
          <div className='absolute top-0 left-0 right-0 z-10 p-6 bg-gradient-to-b from-black/70 to-transparent'>
            <div className='flex items-center justify-between text-white'>
              <div>
                <h2 className='text-2xl font-semibold'>{otherParticipant?.userName || 'Unknown'}</h2>
              ...
              <div className='flex items-center space-x-2'>
                ...
                <span className='text-sm uppercase tracking-wider'>{isVideoCall ? 'Video Call' : 'Voice Call'}</span>
              </div>
            </div>
          </div>

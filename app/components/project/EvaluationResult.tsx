        ...
        <div className='grid md:grid-cols-2 gap-6'>
          ...
          <div className='space-y-4'>
            ...
            <div>
              ...
              <Progress
                value={result.technicalAccuracyScore * 10}
                className={getScoreColor(result.technicalAccuracyScore)}
              />
            </div>
            <div>
              <div className='flex justify-between mb-1'>
              ...
              <Progress
                value={result.styleComplianceScore * 10}
                className={getScoreColor(result.styleComplianceScore)}
              />
            </div>
            <div>
              <div className='flex justify-between mb-1'>
